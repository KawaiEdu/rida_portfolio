...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "9efb4ac9-2536-4310-94c0-f885c4d45477",
...
const require2 = createRequire(join$1(process.cwd(), "server/utils/db.ts"));
let dbInstance = null;
class NodeSqliteWrapper {
  constructor(path) {
    __publicField(this, "rawDb");
...
function useDb() {
  if (!dbInstance) {
    const dbPath = join$1(process.cwd(), "sqlite.db");
    try {
      const { DatabaseSync } = require2("node:sqlite");
      if (DatabaseSync) {
...
const _DBBYB8m_SE1fsAryKKFLRcXZRYzltvnsdRROhCitKcI = defineNitroPlugin(() => {
  const db = useDb();
  db.exec(`
  ...
  const defaultSettings = [
    ...
    { key: "hero_tag", value: "AKADEMISI \xB7 AUDITOR \xB7 KONSULTAN" },
    { key: "seal_line1", value: "AK. \xB7 CA. \xB7 CPA." },
    { key: "seal_line2", value: "CFRA. \xB7 CIPSAS. \xB7 DR." },
  ...
  const projectsCheck = db.prepare("SELECT COUNT(*) as count FROM projects").get();
  if (projectsCheck.count === 0) {
    ...
    const transaction2 = db.transaction((projectsList) => {
      for (const p of projectsList) {
        insertProject.run(p.title, p.description, p.visual_class, p.link);
      }
    });
    transaction2(defaultProjects);
    console.log("[Init DB] Default projects seeded.");
  }
  const servicesCheck = db.prepare("SELECT COUNT(*) as count FROM services").get();
  if (servicesCheck.count === 0) {
    ...
    const transaction2 = db.transaction((servicesList) => {
      for (const s of servicesList) {
        insertService.run(s.title, s.description, s.category, s.is_highlighted, s.visual_svg_type);
      }
    });
    transaction2(defaultServices);
    console.log("[Init DB] Default services seeded.");
  }
  const blogsCheck = db.prepare("SELECT COUNT(*) as count FROM blogs").get();
...
Simak langkah strategis mitigasi risikonya di artikel lengkap ini.`,
    ...
    const transaction2 = db.transaction((blogsList) => {
      for (const b of blogsList) {
        insertBlog.run(b.title, b.slug, b.content, b.image_url, b.status);
      }
    });
    transaction2(defaultBlogs);
    console.log("[Init DB] Default blogs seeded.");
  }
  const publicationsCheck = db.prepare("SELECT COUNT(*) as count FROM publications").get();
  if (publicationsCheck.count === 0) {
    ...
    const transaction2 = db.transaction((pubList) => {
      for (const p of pubList) {
        insertPub.run(p.title, p.type, p.link, p.description);
      }
    });
    transaction2(defaultPublications);
    console.log("[Init DB] Default publications seeded.");
  }
  const certificationsCheck = db.prepare("SELECT COUNT(*) as count FROM certifications").get();
  if (certificationsCheck.count === 0) {
    ...
    const transaction2 = db.transaction((certList) => {
      for (const c of certList) {
        insertCert.run(c.short_name, c.title, c.description);
      }
    });
    transaction2(defaultCertifications);
    console.log("[Init DB] Default certifications seeded.");
  }
});

const plugins = [
  _DBBYB8m_SE1fsAryKKFLRcXZRYzltvnsdRROhCitKcI
];

const assets = {
  "/_nuxt/8cyOHMec.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"723-FpbsXFn212J8LRUQqJw2GqkJX1s\"",
    "mtime": "2026-07-17T11:12:56.836Z",
    "size": 1827,
    "path": "../public/_nuxt/8cyOHMec.js"
  },
  "/robots.txt": {
  ...
  "/_nuxt/BVhFNG3t.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"6071-H7i79Epc5bSQLQyeaHg+4z3Y4ZE\"",
    "mtime": "2026-07-17T11:12:56.836Z",
    "size": 24689,
    "path": "../public/_nuxt/BVhFNG3t.js"
  },
  "/_nuxt/CHDlQRCd.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"24bf-ayJ/0/xZtMWv2ap24shqLxs5BV4\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 9407,
    "path": "../public/_nuxt/CHDlQRCd.js"
  },
  ...
  "/_nuxt/CKWydHVo.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"72d8-kaLF9R5I7LHtBKzoAeK2SpaFEzQ\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 29400,
    "path": "../public/_nuxt/CKWydHVo.js"
  },
  "/_nuxt/k-9IT9DK.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"146-jA81NT307kCuUVJMcNaPUEckITE\"",
    "mtime": "2026-07-17T11:12:56.836Z",
    "size": 326,
    "path": "../public/_nuxt/k-9IT9DK.js"
  },
  "/_nuxt/login.CS-XoW5R.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"965-uaEFbg9BS+ckMxshuJMa7WA28jg\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 2405,
    "path": "../public/_nuxt/login.CS-XoW5R.css"
  },
  "/_nuxt/rbjyyL9p.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"140-Xv3rHqOStUzj8Rp/EoEfx5+SMHk\"",
    "mtime": "2026-07-17T11:12:56.840Z",
    "size": 320,
    "path": "../public/_nuxt/rbjyyL9p.js"
  },
  "/_nuxt/dashboard.DuiICt80.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"21ad-NffZgXjjsioM6Go0Z2AEjOOWVM8\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 8621,
    "path": "../public/_nuxt/dashboard.DuiICt80.css"
  },
  "/_nuxt/Z5ZGq6ug.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"d96-3bj/8zenjwtIJjWX1cYcf94EQFY\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 3478,
    "path": "../public/_nuxt/Z5ZGq6ug.js"
  },
  "/_nuxt/index.BCjXof8K.css": {
    "type": "text/css; charset=utf-8",
    "etag": "\"88dc-QEspJ+t9p5hD8ibDpsD7BxTTpok\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 35036,
    "path": "../public/_nuxt/index.BCjXof8K.css"
  },
  "/_nuxt/builds/latest.json": {
    "type": "application/json",
    "etag": "\"47-tzguRs+HY3UhiP39uAfEoxkFHQo\"",
    "mtime": "2026-07-17T11:12:58.219Z",
    "size": 71,
    "path": "../public/_nuxt/builds/latest.json"
  },
  "/_nuxt/wZNA8J25.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3cd6-pDlPn32oVMsUk0LAqPNAeUyKF4A\"",
    "mtime": "2026-07-17T11:12:56.838Z",
    "size": 15574,
    "path": "../public/_nuxt/wZNA8J25.js"
  },
  "/uploads/upload-1781937251772.JPG": {
    "type": "image/jpeg",
    "etag": "\"2f47a0-g8VQ7bP+fTna+vJOk0GhmSSUNcI\"",
    "mtime": "2026-06-20T06:34:11.781Z",
    "size": 3098528,
    "path": "../public/uploads/upload-1781937251772.JPG"
  },
  "/uploads/upload-1782716348963.JPG": {
    "type": "image/jpeg",
    "etag": "\"2f47a0-g8VQ7bP+fTna+vJOk0GhmSSUNcI\"",
    "mtime": "2026-06-29T06:59:09.014Z",
    "size": 3098528,
    "path": "../public/uploads/upload-1782716348963.JPG"
  },
  "/images/rida_profile.jpg": {
    "type": "image/jpeg",
    "etag": "\"2f47a0-g8VQ7bP+fTna+vJOk0GhmSSUNcI\"",
    "mtime": "2025-10-19T05:14:36.075Z",
    "size": 3098528,
    "path": "../public/images/rida_profile.jpg"
  },
  "/uploads/upload-1782720908925.jpg": {
    "type": "image/jpeg",
    "etag": "\"2f47a0-g8VQ7bP+fTna+vJOk0GhmSSUNcI\"",
    "mtime": "2026-06-29T08:15:08.971Z",
    "size": 3098528,
    "path": "../public/uploads/upload-1782720908925.jpg"
  },
  "/uploads/upload-1783934525361.JPG": {
    "type": "image/jpeg",
    "etag": "\"2f47a0-g8VQ7bP+fTna+vJOk0GhmSSUNcI\"",
    "mtime": "2026-07-13T09:32:35.651Z",
    "size": 3098528,
    "path": "../public/uploads/upload-1783934525361.JPG"
  },
  "/uploads/upload-1783934558257.JPG": {
    "type": "image/jpeg",
    "etag": "\"2ee8ef-TBaOGG7P2Ez8333B9T0p7mH+CBs\"",
    "mtime": "2026-07-13T09:32:35.687Z",
    "size": 3074287,
    "path": "../public/uploads/upload-1783934558257.JPG"
  },
  "/_nuxt/builds/meta/9efb4ac9-2536-4310-94c0-f885c4d45477.json": {
    "type": "application/json",
    "etag": "\"58-h43vHafAQu8ttoACKCrc3qs5tsg\"",
    "mtime": "2026-07-17T11:12:58.219Z",
    "size": 88,
    "path": "../public/_nuxt/builds/meta/9efb4ac9-2536-4310-94c0-f885c4d45477.json"
  },
  "/_nuxt/Bi1YvRrA.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"29800-rBF6VwjsmGSi/BUZph+A5n1ZEIA\"",
    "mtime": "2026-07-17T11:12:56.835Z",
    "size": 169984,
    "path": "../public/_nuxt/Bi1YvRrA.js"
  }
};
...
const _pl39bs = eventHandler((event) => {
...
const _lazy_xbjs6B = () => import('../routes/api/auth/login.post.mjs');
const _lazy_55lU6V = () => import('../routes/api/auth/logout.post.mjs');
const _lazy_8zSIcG = () => import('../routes/api/auth/me.get.mjs');
const _lazy_KFP1b8 = () => import('../routes/api/blogs/_id_.delete.mjs');
const _lazy_onHrpy = () => import('../routes/api/blogs/_slug_.get.mjs');
const _lazy_Co34kT = () => import('../routes/api/index.get.mjs');
const _lazy_iYX9so = () => import('../routes/api/index.post.mjs');
const _lazy_x8YxMV = () => import('../routes/api/contact/_id_.delete.mjs');
const _lazy_WW14Qo = () => import('../routes/api/index2.get.mjs');
const _lazy_I770y5 = () => import('../routes/api/index2.post.mjs');
const _lazy_bgDn8x = () => import('../routes/api/projects/_id_.delete.mjs');
const _lazy_SToYrV = () => import('../routes/api/index3.get.mjs');
const _lazy_Xk4Xzb = () => import('../routes/api/index3.post.mjs');
const _lazy_50kTIW = () => import('../routes/api/publications/_id_.delete.mjs');
const _lazy_1DgMDd = () => import('../routes/api/index4.get.mjs');
const _lazy_lROkBc = () => import('../routes/api/index4.post.mjs');
const _lazy_DReVPk = () => import('../routes/api/services.get.mjs');
const _lazy_H09Put = () => import('../routes/api/settings.get.mjs');
const _lazy_BnxnVP = () => import('../routes/api/settings.post.mjs');
const _lazy_21mZbt = () => import('../routes/api/upload.post.mjs');
const _lazy_bNriPg = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _pl39bs, lazy: false, middleware: true, method: undefined },
  { route: '/api/auth/login', handler: _lazy_xbjs6B, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_55lU6V, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/me', handler: _lazy_8zSIcG, lazy: true, middleware: false, method: "get" },
  { route: '/api/blogs/:id', handler: _lazy_KFP1b8, lazy: true, middleware: false, method: "delete" },
  { route: '/api/blogs/:slug', handler: _lazy_onHrpy, lazy: true, middleware: false, method: "get" },
  { route: '/api/blogs', handler: _lazy_Co34kT, lazy: true, middleware: false, method: "get" },
  { route: '/api/blogs', handler: _lazy_iYX9so, lazy: true, middleware: false, method: "post" },
  { route: '/api/contact/:id', handler: _lazy_x8YxMV, lazy: true, middleware: false, method: "delete" },
  { route: '/api/contact', handler: _lazy_WW14Qo, lazy: true, middleware: false, method: "get" },
  { route: '/api/contact', handler: _lazy_I770y5, lazy: true, middleware: false, method: "post" },
  { route: '/api/projects/:id', handler: _lazy_bgDn8x, lazy: true, middleware: false, method: "delete" },
  { route: '/api/projects', handler: _lazy_SToYrV, lazy: true, middleware: false, method: "get" },
  { route: '/api/projects', handler: _lazy_Xk4Xzb, lazy: true, middleware: false, method: "post" },
  { route: '/api/publications/:id', handler: _lazy_50kTIW, lazy: true, middleware: false, method: "delete" },
  { route: '/api/publications', handler: _lazy_1DgMDd, lazy: true, middleware: false, method: "get" },
  { route: '/api/publications', handler: _lazy_lROkBc, lazy: true, middleware: false, method: "post" },
  { route: '/api/services', handler: _lazy_DReVPk, lazy: true, middleware: false, method: "get" },
  { route: '/api/settings', handler: _lazy_H09Put, lazy: true, middleware: false, method: "get" },
  { route: '/api/settings', handler: _lazy_BnxnVP, lazy: true, middleware: false, method: "post" },
  { route: '/api/upload', handler: _lazy_21mZbt, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_bNriPg, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_bNriPg, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, joinURL as A, withQuery as B, sanitizeStatusCode as C, getContext as D, executeAsync as E, defu as F, getRequestHeaders as G, hash$1 as H, parseQuery as I, withTrailingSlash as J, withoutTrailingSlash as K, trapUnhandledNodeErrors as a, useNitroApp as b, defineEventHandler as c, destr as d, createError$1 as e, useDb as f, setCookie as g, deleteCookie as h, getCookie as i, getRouterParam as j, readMultipartFormData as k, joinRelativeURL as l, encodePath as m, defineRenderHandler as n, getQuery as o, getRouteRules as p, getResponseStatusText as q, readBody as r, setupGracefulShutdown as s, toNodeListener as t, useRuntimeConfig as u, getResponseStatus as v, parseURL as w, decodePath as x, hasProtocol as y, isScriptProtocol as z };
