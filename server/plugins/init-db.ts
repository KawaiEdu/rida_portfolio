...
export default defineNitroPlugin(() => {
  ...
  const defaultSettings = [
    ...
    { key: 'services_title', value: 'Tujuh layanan, tiga ranah kerja.' },
    { key: 'services_subtitle', value: 'Dari ruang audit hingga ruang kelas — setiap layanan berangkat dari kombinasi kompetensi akademik dan jam terbang praktik.' },
